...
import com.solace.sempconfigclient.model.EventThresholdByValue;
...
public class MsgVpn   {
  ...
  @JsonProperty("sempOverMsgBusLegacyShowClearEnabled")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The maximum number of local client subscriptions (both primary and backup) that can be added to this Message VPN. The default varies by platform.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The maximum number of transacted sessions for this Message VPN. The default varies by platform.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The maximum number of transactions for this Message VPN. The default varies by platform.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The maximum number of REST consumer connections that can be simultaneously established from the Message VPN. The default varies by platform.")
