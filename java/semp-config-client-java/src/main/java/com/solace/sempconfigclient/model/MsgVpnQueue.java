...
public class MsgVpnQueue   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "The max spool usage (in MB) of this queue. Setting the value to 0 enables the last-value-queue feature and disables quota checking. The default varies by platform.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accessType, consumerAckPropagationEnabled, egressEnabled, eventBindCountThreshold, eventMsgSpoolUsageThreshold, eventRejectLowPriorityMsgLimitThreshold, ingressEnabled, maxBindCount, maxDeliveredUnackedMsgsPerFlow, maxMsgSize, maxMsgSpoolUsage, maxRedeliveryCount, maxTtl, msgVpnName, owner, permission, queueName, rejectLowPriorityMsgEnabled, rejectLowPriorityMsgLimit, respectTtlEnabled);
  }
