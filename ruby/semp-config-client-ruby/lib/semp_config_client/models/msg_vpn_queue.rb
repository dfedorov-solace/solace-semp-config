...
module SEMPConfigClient
  ...
  class MsgVpnQueue
    ...
    def hash
      [access_type, consumer_ack_propagation_enabled, egress_enabled, event_bind_count_threshold, event_msg_spool_usage_threshold, event_reject_low_priority_msg_limit_threshold, ingress_enabled, max_bind_count, max_delivered_unacked_msgs_per_flow, max_msg_size, max_msg_spool_usage, max_redelivery_count, max_ttl, msg_vpn_name, owner, permission, queue_name, reject_low_priority_msg_enabled, reject_low_priority_msg_limit, respect_ttl_enabled].hash
    end
    ...
    def _deserialize(type, value)
      ...
      when /\AHash<(?<k_type>.+), (?<v_type>.+)>\z/
        ...
        temp_model = SEMPConfigClient.const_get(type).new
