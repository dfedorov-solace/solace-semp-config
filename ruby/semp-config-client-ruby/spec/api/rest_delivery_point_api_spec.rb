...
# Unit tests for SEMPConfigClient::RestDeliveryPointApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RestDeliveryPointApi' do
  before do
    # run before each test
    @instance = SEMPConfigClient::RestDeliveryPointApi.new
  end
  ...
  describe 'test an instance of RestDeliveryPointApi' do
    it 'should create an instact of RestDeliveryPointApi' do
      expect(@instance).to be_instance_of(SEMPConfigClient::RestDeliveryPointApi)
    end
  end
