...
# Unit tests for SEMPConfigClient::ClientUsernameApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClientUsernameApi' do
  before do
    # run before each test
    @instance = SEMPConfigClient::ClientUsernameApi.new
  end
  ...
  describe 'test an instance of ClientUsernameApi' do
    it 'should create an instact of ClientUsernameApi' do
      expect(@instance).to be_instance_of(SEMPConfigClient::ClientUsernameApi)
    end
  end
