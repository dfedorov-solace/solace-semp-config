...
# Unit tests for SEMPConfigClient::AclProfileApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AclProfileApi' do
  before do
    # run before each test
    @instance = SEMPConfigClient::AclProfileApi.new
  end
  ...
  describe 'test an instance of AclProfileApi' do
    it 'should create an instact of AclProfileApi' do
      expect(@instance).to be_instance_of(SEMPConfigClient::AclProfileApi)
    end
  end
