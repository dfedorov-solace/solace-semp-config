...
describe SEMPConfigClient::Configuration do
  let(:config) { SEMPConfigClient::Configuration.default }

  before(:each) do
    # uncomment below to setup host and base_path
    #require 'URI'
    #uri = URI.parse("http://www.solace.com/SEMP/v2/config")
    #SEMPConfigClient.configure do |c|
    #  c.host = uri.host
  ...
  describe '#base_url' do
    it 'should have the default value' do
      ...
      #expect(config.base_url).to eq("http://www.solace.com/SEMP/v2/config")
    end
