...
# Unit tests for SEMPConfigClient::MsgVpnBridgeLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeLinks' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnBridgeLinks.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeLinks' do
    it 'should create an instact of MsgVpnBridgeLinks' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnBridgeLinks)
    end
  end
