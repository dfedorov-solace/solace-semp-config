...
# Unit tests for SEMPConfigClient::MsgVpnRestDeliveryPointRestConsumer
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointRestConsumer' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnRestDeliveryPointRestConsumer.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointRestConsumer' do
    it 'should create an instact of MsgVpnRestDeliveryPointRestConsumer' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnRestDeliveryPointRestConsumer)
    end
  end
