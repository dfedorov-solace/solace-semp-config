...
# Unit tests for SEMPConfigClient::MsgVpnAclProfilePublishException
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfilePublishException' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnAclProfilePublishException.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfilePublishException' do
    it 'should create an instact of MsgVpnAclProfilePublishException' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnAclProfilePublishException)
    end
  end
