...
# Unit tests for SEMPConfigClient::MsgVpnQueueSubscriptionsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnQueueSubscriptionsResponse' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnQueueSubscriptionsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnQueueSubscriptionsResponse' do
    it 'should create an instact of MsgVpnQueueSubscriptionsResponse' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnQueueSubscriptionsResponse)
    end
  end
