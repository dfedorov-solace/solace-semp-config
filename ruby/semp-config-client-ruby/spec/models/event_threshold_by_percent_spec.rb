...
# Unit tests for SEMPConfigClient::EventThresholdByPercent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventThresholdByPercent' do
  before do
    # run before each test
    @instance = SEMPConfigClient::EventThresholdByPercent.new
  end
  ...
  describe 'test an instance of EventThresholdByPercent' do
    it 'should create an instact of EventThresholdByPercent' do
      expect(@instance).to be_instance_of(SEMPConfigClient::EventThresholdByPercent)
    end
  end
