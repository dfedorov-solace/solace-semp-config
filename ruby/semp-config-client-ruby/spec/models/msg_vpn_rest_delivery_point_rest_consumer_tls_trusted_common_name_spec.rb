...
# Unit tests for SEMPConfigClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName' do
    it 'should create an instact of MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnRestDeliveryPointRestConsumerTlsTrustedCommonName)
    end
  end
