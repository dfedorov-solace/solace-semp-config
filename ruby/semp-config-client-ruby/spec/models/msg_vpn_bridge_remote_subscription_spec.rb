...
# Unit tests for SEMPConfigClient::MsgVpnBridgeRemoteSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeRemoteSubscription' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnBridgeRemoteSubscription.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeRemoteSubscription' do
    it 'should create an instact of MsgVpnBridgeRemoteSubscription' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnBridgeRemoteSubscription)
    end
  end
