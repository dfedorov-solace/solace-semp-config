...
# Unit tests for SEMPConfigClient::MsgVpnRestDeliveryPointQueueBindingLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointQueueBindingLinks' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnRestDeliveryPointQueueBindingLinks.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointQueueBindingLinks' do
    it 'should create an instact of MsgVpnRestDeliveryPointQueueBindingLinks' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnRestDeliveryPointQueueBindingLinks)
    end
  end
