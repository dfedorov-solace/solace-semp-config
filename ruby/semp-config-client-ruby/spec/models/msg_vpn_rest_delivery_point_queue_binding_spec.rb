...
# Unit tests for SEMPConfigClient::MsgVpnRestDeliveryPointQueueBinding
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointQueueBinding' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnRestDeliveryPointQueueBinding.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointQueueBinding' do
    it 'should create an instact of MsgVpnRestDeliveryPointQueueBinding' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnRestDeliveryPointQueueBinding)
    end
  end
