...
# Unit tests for SEMPConfigClient::MsgVpnBridgeRemoteMsgVpnResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeRemoteMsgVpnResponse' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnBridgeRemoteMsgVpnResponse.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeRemoteMsgVpnResponse' do
    it 'should create an instact of MsgVpnBridgeRemoteMsgVpnResponse' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnBridgeRemoteMsgVpnResponse)
    end
  end
