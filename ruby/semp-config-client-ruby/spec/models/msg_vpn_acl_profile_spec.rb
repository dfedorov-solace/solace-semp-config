...
# Unit tests for SEMPConfigClient::MsgVpnAclProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfile' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnAclProfile.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfile' do
    it 'should create an instact of MsgVpnAclProfile' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnAclProfile)
    end
  end
