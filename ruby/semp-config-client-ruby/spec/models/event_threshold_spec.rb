...
# Unit tests for SEMPConfigClient::EventThreshold
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EventThreshold' do
  before do
    # run before each test
    @instance = SEMPConfigClient::EventThreshold.new
  end
  ...
  describe 'test an instance of EventThreshold' do
    it 'should create an instact of EventThreshold' do
      expect(@instance).to be_instance_of(SEMPConfigClient::EventThreshold)
    end
  end
