...
# Unit tests for SEMPConfigClient::MsgVpnQueueSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnQueueSubscription' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnQueueSubscription.new
  end
  ...
  describe 'test an instance of MsgVpnQueueSubscription' do
    it 'should create an instact of MsgVpnQueueSubscription' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnQueueSubscription)
    end
  end
