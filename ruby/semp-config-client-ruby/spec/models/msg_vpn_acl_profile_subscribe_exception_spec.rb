...
# Unit tests for SEMPConfigClient::MsgVpnAclProfileSubscribeException
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileSubscribeException' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnAclProfileSubscribeException.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileSubscribeException' do
    it 'should create an instact of MsgVpnAclProfileSubscribeException' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnAclProfileSubscribeException)
    end
  end
