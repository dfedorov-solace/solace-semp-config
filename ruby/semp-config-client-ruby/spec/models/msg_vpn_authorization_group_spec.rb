...
# Unit tests for SEMPConfigClient::MsgVpnAuthorizationGroup
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAuthorizationGroup' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnAuthorizationGroup.new
  end
  ...
  describe 'test an instance of MsgVpnAuthorizationGroup' do
    it 'should create an instact of MsgVpnAuthorizationGroup' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnAuthorizationGroup)
    end
  end
