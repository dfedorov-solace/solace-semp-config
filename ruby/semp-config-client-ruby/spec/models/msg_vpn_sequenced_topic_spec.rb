...
# Unit tests for SEMPConfigClient::MsgVpnSequencedTopic
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnSequencedTopic' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnSequencedTopic.new
  end
  ...
  describe 'test an instance of MsgVpnSequencedTopic' do
    it 'should create an instact of MsgVpnSequencedTopic' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnSequencedTopic)
    end
  end
