...
# Unit tests for SEMPConfigClient::MsgVpnAclProfilePublishExceptionsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfilePublishExceptionsResponse' do
  before do
    # run before each test
    @instance = SEMPConfigClient::MsgVpnAclProfilePublishExceptionsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfilePublishExceptionsResponse' do
    it 'should create an instact of MsgVpnAclProfilePublishExceptionsResponse' do
      expect(@instance).to be_instance_of(SEMPConfigClient::MsgVpnAclProfilePublishExceptionsResponse)
    end
  end
