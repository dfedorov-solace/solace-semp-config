...
Gem::Specification.new do |s|
  s.name        = "semp_config_client"
  s.version     = SEMPConfigClient::VERSION
  s.platform    = Gem::Platform::RUBY
  s.authors     = ["Solace Corp"]
  s.email       = ["support_request@solace.com"]
  s.homepage    = "http://solace.com"
  s.summary     = "A Ruby client wrapper around SEMP Config API"
  s.description = "This gem maps to a SEMP Config API used for configuring a Solace router"
