...
# Unit tests for SwaggerClient::MsgVpnQueueLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnQueueLinks' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnQueueLinks.new
  end
  ...
  describe 'test an instance of MsgVpnQueueLinks' do
    it 'should create an instact of MsgVpnQueueLinks' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnQueueLinks)
    end
  end
