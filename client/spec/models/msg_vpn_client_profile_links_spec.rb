...
# Unit tests for SwaggerClient::MsgVpnClientProfileLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnClientProfileLinks' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnClientProfileLinks.new
  end
  ...
  describe 'test an instance of MsgVpnClientProfileLinks' do
    it 'should create an instact of MsgVpnClientProfileLinks' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnClientProfileLinks)
    end
  end
