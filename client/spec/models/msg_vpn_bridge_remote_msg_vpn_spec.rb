...
# Unit tests for SwaggerClient::MsgVpnBridgeRemoteMsgVpn
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeRemoteMsgVpn' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnBridgeRemoteMsgVpn.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeRemoteMsgVpn' do
    it 'should create an instact of MsgVpnBridgeRemoteMsgVpn' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnBridgeRemoteMsgVpn)
    end
  end
