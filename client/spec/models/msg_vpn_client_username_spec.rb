...
# Unit tests for SwaggerClient::MsgVpnClientUsername
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnClientUsername' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnClientUsername.new
  end
  ...
  describe 'test an instance of MsgVpnClientUsername' do
    it 'should create an instact of MsgVpnClientUsername' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnClientUsername)
    end
  end
