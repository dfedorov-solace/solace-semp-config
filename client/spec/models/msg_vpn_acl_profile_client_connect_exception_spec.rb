...
# Unit tests for SwaggerClient::MsgVpnAclProfileClientConnectException
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileClientConnectException' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnAclProfileClientConnectException.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileClientConnectException' do
    it 'should create an instact of MsgVpnAclProfileClientConnectException' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnAclProfileClientConnectException)
    end
  end
