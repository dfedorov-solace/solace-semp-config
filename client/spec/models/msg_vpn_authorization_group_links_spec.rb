...
# Unit tests for SwaggerClient::MsgVpnAuthorizationGroupLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAuthorizationGroupLinks' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnAuthorizationGroupLinks.new
  end
  ...
  describe 'test an instance of MsgVpnAuthorizationGroupLinks' do
    it 'should create an instact of MsgVpnAuthorizationGroupLinks' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnAuthorizationGroupLinks)
    end
  end
