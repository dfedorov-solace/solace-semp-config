...
# Unit tests for SwaggerClient::MsgVpnBridgeRemoteSubscriptionResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeRemoteSubscriptionResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnBridgeRemoteSubscriptionResponse.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeRemoteSubscriptionResponse' do
    it 'should create an instact of MsgVpnBridgeRemoteSubscriptionResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnBridgeRemoteSubscriptionResponse)
    end
  end
