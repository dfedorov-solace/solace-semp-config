...
# Unit tests for SwaggerClient::MsgVpnBridgeRemoteSubscription
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeRemoteSubscription' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnBridgeRemoteSubscription.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeRemoteSubscription' do
    it 'should create an instact of MsgVpnBridgeRemoteSubscription' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnBridgeRemoteSubscription)
    end
  end
