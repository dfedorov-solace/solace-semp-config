...
# Unit tests for SwaggerClient::MsgVpnRestDeliveryPointLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnRestDeliveryPointLinks' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnRestDeliveryPointLinks.new
  end
  ...
  describe 'test an instance of MsgVpnRestDeliveryPointLinks' do
    it 'should create an instact of MsgVpnRestDeliveryPointLinks' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnRestDeliveryPointLinks)
    end
  end
