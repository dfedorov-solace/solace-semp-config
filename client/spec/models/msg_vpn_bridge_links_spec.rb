...
# Unit tests for SwaggerClient::MsgVpnBridgeLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnBridgeLinks' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnBridgeLinks.new
  end
  ...
  describe 'test an instance of MsgVpnBridgeLinks' do
    it 'should create an instact of MsgVpnBridgeLinks' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnBridgeLinks)
    end
  end
