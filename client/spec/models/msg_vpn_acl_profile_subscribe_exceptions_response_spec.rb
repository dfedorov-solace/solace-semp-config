...
# Unit tests for SwaggerClient::MsgVpnAclProfileSubscribeExceptionsResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileSubscribeExceptionsResponse' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnAclProfileSubscribeExceptionsResponse.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileSubscribeExceptionsResponse' do
    it 'should create an instact of MsgVpnAclProfileSubscribeExceptionsResponse' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnAclProfileSubscribeExceptionsResponse)
    end
  end
