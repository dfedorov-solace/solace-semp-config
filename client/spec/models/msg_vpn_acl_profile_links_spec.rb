...
# Unit tests for SwaggerClient::MsgVpnAclProfileLinks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileLinks' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnAclProfileLinks.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileLinks' do
    it 'should create an instact of MsgVpnAclProfileLinks' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnAclProfileLinks)
    end
  end
