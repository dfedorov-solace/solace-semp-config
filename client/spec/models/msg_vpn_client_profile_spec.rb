...
# Unit tests for SwaggerClient::MsgVpnClientProfile
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnClientProfile' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnClientProfile.new
  end
  ...
  describe 'test an instance of MsgVpnClientProfile' do
    it 'should create an instact of MsgVpnClientProfile' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnClientProfile)
    end
  end
