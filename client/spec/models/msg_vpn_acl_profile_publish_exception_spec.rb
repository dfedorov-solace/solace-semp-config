...
# Unit tests for SwaggerClient::MsgVpnAclProfilePublishException
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfilePublishException' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnAclProfilePublishException.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfilePublishException' do
    it 'should create an instact of MsgVpnAclProfilePublishException' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnAclProfilePublishException)
    end
  end
