...
# Unit tests for SwaggerClient::MsgVpnAclProfileSubscribeException
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MsgVpnAclProfileSubscribeException' do
  before do
    # run before each test
    @instance = SwaggerClient::MsgVpnAclProfileSubscribeException.new
  end
  ...
  describe 'test an instance of MsgVpnAclProfileSubscribeException' do
    it 'should create an instact of MsgVpnAclProfileSubscribeException' do
      expect(@instance).to be_instance_of(SwaggerClient::MsgVpnAclProfileSubscribeException)
    end
  end
