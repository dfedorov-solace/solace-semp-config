...
# Unit tests for SwaggerClient::ClientProfileApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ClientProfileApi' do
  before do
    # run before each test
    @instance = SwaggerClient::ClientProfileApi.new
  end
  ...
  describe 'test an instance of ClientProfileApi' do
    it 'should create an instact of ClientProfileApi' do
      expect(@instance).to be_instance_of(SwaggerClient::ClientProfileApi)
    end
  end
